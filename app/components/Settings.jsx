...
const Settings = () => {
  ...
  const [translationFontSize, setTranslationFontSize] = useState(29);
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col ">
        <label htmlFor="arFontSize" className="font-semibold tracking-wider">
          এরাবিক ফন্ট সাইজ
        </label>
        <div className="flex gap-2 font-bold">
          ...
          />
          <p>{translationFontSize}</p>
        </div>
      </div>

      <div className="flex flex-col">
        <label htmlFor="tr_FontSize" className="font-semibold tracking-wider">
          অনুবাদ ফন্ট সাইজ
        </label>
      ...
      <div className="flex justify-between">
        <label
          className="inline-block pl-[0.15rem] hover:cursor-pointer tracking-wider font-semibold"
